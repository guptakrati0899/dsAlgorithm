...
public class NodeUtility {
	...
	public Node readFile(Node start)
	{
		try
		{
			FileInputStream fis = new FileInputStream("C:\\Users\\Asus\\eclipse-workspace\\dsAlgorithm\\Demofolder\\Integer.txt");
			char ch;
			String word3="";
	...
	public int[] integerFileReader()
	{
		try
		{
			...
			FileReader fr = new FileReader("C:\\Users\\Asus\\eclipse-workspace\\dsAlgorithm\\Demofolder\\Integer.txt");
  	...
  	public void writeFile(Node tNode)
	{
		...
		{
			String tString="";
		    File file=new File("C:\\Users\\Asus\\eclipse-workspace\\dsAlgorithm\\Demofolder\\Newtext.txt");
		    file.createNewFile();
