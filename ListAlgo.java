...
public class ListAlgo {
		...
		{
			try{
		           	FileInputStream fis = new FileInputStream("C:\\Users\\Asus\\eclipse-workspace\\dsAlgorithm\\Demofolder\\demo1text.txt");
		           	char ch;
		           	String word3="";
		...
		{
			try{
				File fi=new File("C:\\Users\\Asus\\eclipse-workspace\\dsAlgorithm\\Demofolder\\demo1text.txt");
		      	fi.createNewFile();
